...
from websitedeploy import app, db, bcrypt
from websitedeploy.forms import RegisterForm, LoginForm, updateprofileForm, New_QuizForm
import pymysql.cursors
from websitedeploy.models import User, Profile, Score, Quiz, Question, Option, Follower, Comment
